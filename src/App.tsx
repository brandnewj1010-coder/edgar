      ...
      <main className="flex min-h-0 min-w-0 flex-1 flex-col border-slate-200 bg-gradient-to-b from-slate-50/80 to-white md:border-r">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-4 py-6 md:px-8 md:py-8">
          <div className="mx-auto mb-4 max-w-[1280px]">
            <div className="flex items-start gap-2 rounded-lg border border-amber-200/80 bg-amber-50/70 px-3 py-2 text-[11px] leading-relaxed text-amber-900">
              <svg
                width="14"
                height="14"
                viewBox="0 0 24 24"
            ...
            >
              ...
              <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between sm:gap-4">
                <div className="min-w-0 space-y-1.5">
                  ...
                  {result.headline ? (
                    <p className="mt-3 max-w-2xl text-[15px] leading-relaxed text-slate-700 md:text-[16px]">
                      <span
